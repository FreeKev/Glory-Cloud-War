...
var winState = {
  ...
  create: function () {
    ...
    if (player2hit === wincount) {
      chooseWinner = "PLAYER 1\nWINS\nTHE CLOUD WAR";
      localStorage.p1++;
    } else if (playerhit === wincount) {
      chooseWinner = "PLAYER 2\nWINS\nTHE CLOUD WAR";
      localStorage.p2++;
    } else {
      console.log('error');
    };

    var wtext = game.add.text(game.world.centerX, game.world.centerY, chooseWinner);
